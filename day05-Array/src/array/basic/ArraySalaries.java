...
/**
 * 직원들의 급여정보(기본형 int 타입)를 저장하는 배열을 테스트하는 클래스
 * 
...
public class ArraySalaries {
	...
	public static void main(String[] args) {
		...
		// 2. 초기화 : 배열 참조 변수는 기본형이 아니므로 초기화를 위해 new 를 사용해야 한다.
		...
		// 결과의 원인 : new 연산자의 기능 >> 칸을 마련 + 원소 타입의 기본값을 초기화
		...
		System.out.println("(1) 값 할당 후 원소 출력==");
		System.out.printf("salaries[0] = %d%n", salaries[0]);
		System.out.printf("salaries[1] = %d%n", salaries[1]);
		System.out.printf("salaries[2] = %d%n", salaries[2]);
		System.out.printf("salaries[3] = %d%n", salaries[3]);
		...
		// 배열이 생성되면 길이를 나타내는 length 변수가 JVL(자바 가상머신)에 의해 생성됨
		System.out.println("salaries 배열의 길이 : " + salaries.length);
		
//		// 만약 index 를 벗어나는 접근을 하게 되면
...
//		 */
		...
		// =================================================================================
		// for loop 와 배열의 조합
		// salaries.length 를 주면 값이 바뀌어도 언제든지 실행 가능
