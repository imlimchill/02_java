...
public class calcTest {
	...
	public static void main(String[] args) {
		// static 이 아닌 메소드를 호출할 때는 해당 메소드가 정의 된 클래스 샛체참조 변수를
		//초기화 후 해당 변수에 메소드를 호출
...
//		cal.add(10.0, 15.2);
		...
		// 자바에소는 클래스의 static 필드들 (변수, 메소드) 에 대해서 static import 지원
		// static import 구문을 클래스 선언 위쪽에 작성한 경우 메소드 이름만으로 호출할수 있다.
