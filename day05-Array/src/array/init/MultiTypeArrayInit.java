...
/**
 * boolean, int, double, String 타입의 우너소를 가지는 배열 네가지를 선언하고
 * 
 * 크기 5로 생성한뒤
 * 
 * 각 배열의 원소가 초기화된 값을 확인한다.
 * 
...
public class MultiTypeArrayInit {
	...
	public static void main(String[] args) {
		...
		System.out.println("(1) double 배열 출력");
		for (double height : heights) {
			System.out.printf("height = %f%n", height);
		}
		
		System.out.println("(1) String 배열 출력");
